...
let nameGreeting = nameCheck("Rick");
...
function kyloUpperCase(str) {
  console.log(str.toUpperCase());
}

kyloUpperCase(sampleString);
...
let email = emailCheck('corey-carter@hotmail.com');
console.log(email);
...
function buysFrogs(gold) {
  let chocolateFrogs = gold / 3;
  return chocolateFrogs;
}


let totalFrogs = buysFrogs(4);
